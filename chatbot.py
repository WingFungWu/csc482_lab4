...
pairs = [
        ['yo|hi|hey|hello|hola|what\'s good', ['Nice to meet you!', 'Hi there!', 'How can I help you?']],
        ['what\'s your name|what is your name?|what are you?|who are you?|your name please?|your name?', ['Hi I\'m Chat482']],
        ...
        ['.*most expensive car.*', ['The most expensive car in the world is the Rolls-Royce Boat Tail, which costs a whopping $28 million']],
        ['.*most expensive vehicle.*', ['The most expensive vehicle is the Airbus A380, which is the world\'s largest passenger airliner and costs about $445.6 million']]
    ]
